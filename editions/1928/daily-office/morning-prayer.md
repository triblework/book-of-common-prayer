<!-- SCOPE (1928): the 1928 American revision did change Daily Morning Prayer, but no clean, freely-reusable transcription was available for this pass -- justus.anglican.org offers the 1928 only as an image/OCR PDF that cannot be transcribed faithfully without introducing errors. To avoid inventing text (see the repo's guardrails), this commit carries the 1892 Daily Office forward unchanged and records the gap here and in SOURCES.md; the 1928-specific Daily Office text is a documented TODO. -->
