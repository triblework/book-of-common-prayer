<!-- SCOPE (1979): the 1979 American book (public domain) rewrote the Daily Office as Rite I (traditional) and Rite II (contemporary): Rite II opens 'Lord, open our lips. / And our mouth shall proclaim your praise.' -- the most dramatic modernization in the whole tradition. It could not be transcribed faithfully this pass because the freely-available 1979 sources are dynamic/JavaScript sites (bookofcommonprayer.net) or day-generated pages (missionstclare.com) that the repo's static scraper cannot capture cleanly, and transcribing from memory is disallowed. This commit carries the prior Daily Office forward and records the gap here and in SOURCES.md; the 1979 Rite I and Rite II text is a documented TODO. -->
...
> On any day when the Holy Communion is immediately to follow, the Minister may, at his discretion, pass at once from the Sentences to the Lord's Prayer, first pronouncing, The Lord be with you.
> Answer.
> And with thy spirit.
> Minister.
> Let us pray.
