...
| 1928 | **not transcribed this pass** | justus provides the 1928 only as an image/OCR PDF (`.../1928/BCP1929.pdf`) that cannot be transcribed faithfully. The commit carries the 1892 Daily Office forward and documents the gap in the file header. TODO: source a clean 1928 transcription. |
