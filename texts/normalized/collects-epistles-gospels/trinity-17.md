...
<!-- VERIFY: 'Proper 23' — 1979 appoints three reading sets for this day under the three-year lectionary, which the single Epistle/Gospel slot cannot represent; deferred to the lectionary-tables wave. -->

<!-- VERIFY: 'Proper 23' — placed at `trinity-17` by COLLECT LINEAGE, not by day: 1979 replaces the Sundays after Trinity with calendar-dated Propers, so it does not observe this day. See ingest/WAVE10_1979_CROSSWALK.md; this representation is flagged for revision. -->
