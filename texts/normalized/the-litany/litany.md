...
<!-- VERIFY: 'in the day of judgment' — raw scrape prints 'in the day our judgment'; 'our' is an OCR corruption of 'of' (cf. 1662 'in the day of judgement'). Confirm against a page scan. -->
Good Lord, deliver us.
...
> The Minister may, of his discretion, omit all that follows, to the Prayer, "We humbly beseech thee, O Father," &c.
...
<!-- VERIFY: 'whensoever they oppress us; and graciously hear us' — raw scrape prints 'oppress us . and graciously', a damaged semicolon (stray space + period + lowercase 'and'); read against 1662 'oppress us; and graciously hear us'. Confirm against a page scan. -->
...
ALMIGHTY God, Father of all mercies, we, thine unworthy servants, do give thee most humble and hearty thanks for all thy goodness and lovingkindness to us, and to all men.
...
Amen.
<!-- VERIFY: 'Fulfill' — raw scrape prints 'Fulfill'; the same-edition (1789) Evening Prayer prints 'Fulfil'. Internal commas here were restored from the parallel (raw prints this prayer nearly comma-stripped). Confirm against a page scan. -->
