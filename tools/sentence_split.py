...
_ABBREVIATIONS = {
    ...
    # Occasion labels in the Tables of Proper Lessons ("1 S. in Ad.",
    # "Sep. Sund.", "S. af. Eph.") and further citation abbreviations.
    "af", "ad", "ch", "sep", "sex", "sund", "quin", "eph", "epiph",
    "circumcision", "epiphany", "nativity", "easter", "even", "week",
    "friday", "wednesday", "trin", "barnabas", "paul", "james",
    "hebr", "revel", "malac", "philipp", "thessal", "tirn", "kng",
    "nu", "sa", "is", "levit", "colos", "ecclus",
